...
router.register(r'nominations', views.NominationViewSet, basename='nomination')
...
urlpatterns = [
    ...
    path('web/nomination/<int:pk>/edit/', web_views.nomination_edit, name='nomination_edit'),
